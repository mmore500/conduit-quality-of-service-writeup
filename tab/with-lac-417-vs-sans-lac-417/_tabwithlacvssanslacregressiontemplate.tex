...
\csvstyle{myTableStyle}{
  ...
  table head=\caption{
    Full \regression{} results of quality of service metrics against categorically coded treatment for faulty hardware experiment (Section \ref{sec:with-lac-417-vs-sans-lac-417}).
