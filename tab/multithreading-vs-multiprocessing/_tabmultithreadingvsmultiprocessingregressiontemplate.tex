...
\csvstyle{myTableStyle}{
  ...
  table head=\caption{
    Full \regression{} results of quality of service metrics against categorically coded treatment for multithreading vs. multiprocessing experiment (Section \ref{sec:multithreading-vs-multiprocessing}).
