...
At 0 units of added compute work, mean and median simstep period was \SI{14.7}{\micro\second}.
...
It should be noted, however, that distinctions in latency below the simulation update rate largely lack practical significance with respect to simulation outcomes.
